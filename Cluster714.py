...
wc = WordCloud(background_color='white',width=8000,height=6000,max_font_size=70,mask=graph,min_font_size=5)#,mode='RGBA',colormap='pink')
wc.generate(result)
...
JaneliaAnalysis(subFeaJanelia_ccf.iloc[:,2*len(ccftable.index):],ccfThre,0,'case1',subFeaJanelia_ccf['Soma'],20)

#%%----------------------------------Case2
#Use normalized (3) sum of 316 brain regions as features
print('***********CASE2 for 966 Features indexed by CCF***********')
ccfThre = np.max(ccfDF['Child num'])
JaneliaAnalysis(subFeaJanelia_ccf.iloc[:,2*len(ccftable.index):],ccfThre,1,'case2',subFeaJanelia_ccf['Soma'],20)
#%%----------------------------------Case3
#Use normalized (1)(2) of 316 regions as features
print('***********CASE3 for 966 Features indexed by CCF***********')
ccfThre = np.max(ccfDF['Child num'])
JaneliaAnalysis(subFeaJanelia_ccf.iloc[:,0:2*len(ccftable.index)],ccfThre,1,'case3',subFeaJanelia_ccf['Soma'],20)  
#%%----------------------------------Case4
#Use normalized (1)(2) of one-child regions as features
print('***********CASE4 for 966 Features indexed by CCF***********')
ccfThre = 1
JaneliaAnalysis(subFeaJanelia_ccf.iloc[:,0:2*len(ccftable.index)],ccfThre,1,'case4',subFeaJanelia_ccf['Soma'],20)  
#%%----------------------------------Case5
#%Use normalized (1)(2) of less-than-median regions as features
print('***********CASE5 for 966 Features indexed by CCF***********')
ccfThre =np.mean(ccfDF['Child num'])
JaneliaAnalysis(subFeaJanelia_ccf.iloc[:,0:2*len(ccftable.index)],ccfThre,1,'case5',subFeaJanelia_ccf['Soma'],20)  
#%%----------------------------------Case6
#Use normalized (3) of one-child regions as features
print('***********CASE6 for 966 Features indexed by CCF***********')
ccfThre =1
JaneliaAnalysis(subFeaJanelia_ccf.iloc[:,2*len(ccftable.index):],ccfThre,1,'case6',subFeaJanelia_ccf['Soma'],20)  
#%%----------------------------------Case7
#Use normalized (3) of less-than-median regions as features    
print('***********CASE7 for 966 Features indexed by CCF***********')
ccfThre = np.mean(ccfDF['Child num'])
JaneliaAnalysis(subFeaJanelia_ccf.iloc[:,2*len(ccftable.index):],ccfThre,1,'case7',subFeaJanelia_ccf['Soma'],20)  
#%%VIsualize the confusion matrix
import matplotlib.pyplot as plt
iterrow=0
for info in os.listdir('/home/penglab/Documents/confuMccf'):
